<div class="comment border p-3" id="comment{{ $i }}">
	...
	<div class="comment-author">
		<div class="row align-items-center spaced-row meta-row">
			...
			<div class="col col-auto">
				<a class="ajax-link" data-bs-toggle="collapse" href="#reply{{ $i }}" role="button" aria-expanded="false" title="Написать развернутый и внятный комментарий, направленный на решение вопроса">Ответить</a>
			</div>
	...
	<div class="comment-reply pt-3 collapse hide" id="reply{{ $i }}">
		<form action="">
	...
	@if(isset($i) && $i==1)
		<div class="comment-answers" id="comment-answers{{ $i }}">
			@include('content.comment2')
		</div>
	@endif
</div>