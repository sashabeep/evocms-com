<div class="comment border p-3">
	...
	<div class="comment-author">
		<div class="row align-items-center spaced-row meta-row">
			...
			<div class="col col-auto">
				<a class="ajax-link" data-bs-toggle="collapse" href="#reply3{{ $i }}" role="button" aria-expanded="false" title="Написать развернутый и внятный комментарий, направленный на решение вопроса">Ответить</a>
			</div>
	...
	<div class="comment-reply pt-3 collapse hide" id="reply3{{ $i }}">
		<form action="">
